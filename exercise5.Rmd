...
**4- Add one row to df: Georges who is 53 years old and 168cm tall.**
...
**6- Create the data frame df2 that is a subset of df containing only the female entries.**
...
**7- Create the data frame df3 that is a subset of df containing only entries of males taller than 170.**
