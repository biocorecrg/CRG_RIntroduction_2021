...
**14- Which elements of y2 are also present in y ?<br>Note: remember the %in% operator.**
...
**16- Use the function any() to check if the number 3 is present.<br>Check the help page of any()!**
